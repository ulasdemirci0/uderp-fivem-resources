...
LumberDepo = {
    ...
    BlipLabel = "Odun Deposu", -- Blip Label
    minZ = 31.92, -- Max Z
    maxZ = 35.92, -- Max Z
...
LumberProcessor = {
    ...
    SetBlipScale = 1.15,
    SetBlipColour = 64,
    BlipLabel = "Kütüp İşleme Merkezi",
    minZ = 77.26,
    maxZ = 81.26,
}
LumberSeller = {
...
Config.Sell = {
    ["tree_lumber"] = {
        ["price"] = math.random(4.5, 6.0) -- Seller Price
    },
    ["tree_bark"] = {
        ["price"] = math.random(2.0, 3.0)
    },
    ["wood_plank"] = {
        ["price"] = math.random(6.5, 10.0)
    },
}
