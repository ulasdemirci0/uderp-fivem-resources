...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsPauseMenuActive() then
            ...
            HideHudComponentThisFrame(22) -- Weapon Stats
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(1, Keys[Config.vehicle.keys.signalLeft]) and (has_value(vehiclesCars, vehicleClass) == true) then
            ...
            TriggerEvent('qb-hud:setCarSignalLights', vehicleSignalIndicator)
        end
...
AddEventHandler('qb-hud:setCarSignalLights', function(status)
    ...
    TriggerServerEvent('qb-hud:syncCarLights', status)
    SetVehicleIndicatorLights(driver, 0, leftLight)
    SetVehicleIndicatorLights(driver, 1, rightLight)
end)

RegisterNetEvent('qb-hud:syncCarLights')
AddEventHandler('qb-hud:syncCarLights', function(driver, status)
