...
AddEventHandler('qb-methcar:smoke', function(posx, posy, posz, bool)
	if bool == 'a' then
		...
		local smoke = StartParticleFxLoopedAtCoord("exp_grd_flare", posx, posy, posz + 1.6, 0.0, 0.0, 0.0, 1.0, false, false,
			false, false)
...
RegisterNetEvent('qb-methcar:cook', function()
	...
	if IsVehicleSeatFree(CurrentVehicle, 3) and IsVehicleSeatFree(CurrentVehicle, -1) and
		IsVehicleSeatFree(CurrentVehicle, 0) and IsVehicleSeatFree(CurrentVehicle, 1) and IsVehicleSeatFree(CurrentVehicle, 2) then
