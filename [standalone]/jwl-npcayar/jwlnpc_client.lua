...
Citizen.CreateThread(function()
	while true do
		...
		SetVehicleDensityMultiplierThisFrame(0.1) -- trafik yoğunluğunu ayarla (max 1)
		SetPedDensityMultiplierThisFrame(0.5) -- npc yoğunluğunu ayarla (max 1)
		SetRandomVehicleDensityMultiplierThisFrame(0.05) -- rastgele araçları (araba senaryoları / park yerinden çıkan arabalar vb.) ayarla (max 1)
