                ...
                if IsControlJustPressed(0, 38) then
                    QBCore.Functions.TriggerCallback("kaves_drugs:checkItemAll", function(output, count)
                        if output then
                            ...
                            QBCore.Functions.Notify("You don't have a sorted money")
                        end
                    end, 'sorted_money')
                end
            end
    ...
    while true do
        ...
        if dst < 5 and not washing then
            ...
            if dst < 2 then
                ...
                if IsControlJustPressed(0, 38) then
                    QBCore.Functions.TriggerCallback("kaves_drugs:checkBlackMoney", function(output)
                        if output then
                            washing = true
                            washcount = output
                            ...
                            QBCore.Functions.Notify("You don't have a black money")
                        end
                    end)
                end
            end
